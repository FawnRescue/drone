...
def main():
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
        ...
        # Request transfer of the RGB image
        sock.sendall(b'transferRGB')
        print("Requested RGB image transfer.")
        
        # Receive and save the RGB image
        data = receive_image(sock)
        if data:
            save_image(data, 'received_rgb_image.png')
            print("Thermal image saved as received_rgb_image.png.")
        else:
